...
<body>
    ...
    <tr> 
    <td style=" border:none; margin-top:1px; font-size:25px; width:100%; text-align:center">  
    <em>  {{ $año}} </em>
    </td>
    </tr>
    </table>
...
<br>
<h2 style="color:red; text-align:center">REPORTE INGRESO POR {{strtoupper($nombre)}}</h2>
