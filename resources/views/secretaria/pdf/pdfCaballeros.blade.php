...
<table width="100%" style="border:none">
    ...
    <tr>
        <td style="border:none; width:100%; font-size:19px; text-align:center"> 
        CENTRAL-TIERRALTA 
        </td>
        </tr>
...
<h2 style="color:red; text-align:center">Listado de Caballeros Bautizados</h2>
<br>
